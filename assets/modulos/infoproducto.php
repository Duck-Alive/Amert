		...
		<div class="row">
			...
			<?php
				...
				if($infoproducto["tipo"] == "fisico"){
					...
					echo '<div class="col-md-4 col-sm-6 col-xs-12 visorImg">
							...
							if($multimedia != null){
								...
								for($i = 0; $i < count($multimedia); $i ++){
									...
									echo '<img style="width:100%;" id="lupa'.($i+1).'" class="img-thumbnail" src="'.$servidor.$multimedia[$i]["foto"].'">';
							...
							if($detalles["Color"]!=null){
								...
								echo '<div class="col-md-3 col-xs-12">
									...
									echo '</select>
										...
										if($detalles["Color"]!=null){
								            for($a = 0; $a <= count($detalles["Color"])-1; $a++){
											echo '<div id="colorSelect"  class="c--anim-colorSelect" style="width:20px; height:20px; cursor:pointer; background: '.$detalles["Color"][$a].'; border-radius:50%;"></div>';
												}
							}
					...
					echo '<li class="col-md-3 col-sm-6 col-xs-12">
						...
						<div class="col-xs-6 enlaces">
							...
							<div class="btn-group pull-right">
								...
								<button type="button" class="btn btn-default btn-xs deseos" idProducto="'.$value["id"].'"  title="Agregar a mi lista de deseos">
								...
								if($value["tipo"] == "virtual" && $value["precio"] != 0){
									...
									if($value["oferta"] != 0){
										...
										echo '<button type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="'.$value["id"].'" imagen="'.$servidor.$value["portada"].'" titulo="'.$value["titulo"].'" precio="'.$value["precioOferta"].'" tipo="'.$value["tipo"].'" peso="'.$value["peso"].'"  title="Agregar al carrito de compras">
										...
										echo '<button type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="'.$value["id"].'" imagen="'.$servidor.$value["portada"].'" titulo="'.$value["titulo"].'" precio="'.$value["precio"].'" tipo="'.$value["tipo"].'" peso="'.$value["peso"].'"  title="Agregar al carrito de compras">
