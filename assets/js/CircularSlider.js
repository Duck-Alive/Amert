        ...
        switch (a) {
            case "openhand":
                jQuery("body").css("cursor",
                    "'url(skinURL+CircularSlider/images/sc-graphics/openhand.cur)', auto");
                break;
            case "closedhand":
                jQuery("body").css("cursor", "url(skinURL+CircularSlider/images/sc-graphics/closedhand.cur), auto");
                break;
            default:
                jQuery("body").css("cursor", a)
                jQuery("body").css("cursor", a)
        }
    },
    hexToRGB: function(a) {
...
SKY.CarouselItem.prototype = {
    init: function() {
        if (!1 == jQuery.support.leadingWhitespace) {
...
SKY.CarouselItem.createReflection = function(a, b, c) {
    var d = a.width(),
        g = a.height(),
        e = null;
    SKY.Utils.hasCanvasSupport() ? (e = jQuery("<canvas>"), ctx = e.get(0).getContext("2d"), e.attr({
        width: d,
        height: b
...
SKY.Carousel = function(a, b) {
    ...
    b && jQuery.extend(this.settings, b);
    this.targetLeft = 0;
...
SKY.Carousel.prototype = {
    ...
    initDOM: function() {
        ...
        a.preload && !1 != jQuery.support.leadingWhitespace && (this.dom.wrapper.css({
            visibility: "hidden",
            opacity: 0
        }), a.showPreloader && (this.preloader = jQuery('<div class="sc-preloader"></div>'), this.dom.carousel.append(this.preloader)));
        this.dom.images.each(function() {
            jQuery(this).addClass("sc-image");
    ...
    initContainer: function() {
        ...
        this.dom.items.each(function(c) {
            c = new SKY.CarouselItem(jQuery(this), a);
    ...
    initContentWrapper: function() {
        var a = jQuery('<div class="sc-content-wrapper"></div>');
        this.contentContainer = jQuery('<div class="sc-content-container"></div>');
        this.contentContainer.append('<div class="sc-content"><section></section></div>');
        a.append(this.contentContainer);
        !1 != jQuery.support.leadingWhitespace &&
    ...
    initNavigationButtons: function() {
        ...
        if (this.settings.navigationButtonsVisible) {
            var b = jQuery('<a href="#" class="sc-nav-button sc-prev sc-no-select"></a>'),
                c = jQuery('<a href="#" class="sc-nav-button sc-next sc-no-select"></a>');
            this.dom.carousel.append(b);
    ...
    initResizeListener: function() {
        var a = this;
        jQuery(window).on("resize", function(b) {
            a.updatePlugin(b)
        })
    },
    ...
    setCurrentContent: function(a) {
        0 < a.content.length ? (this.contentContainer.find("section").html(a.content.children("section").html()),
            this.contentContainer.find("p").html(a.content.children("p").html())) : (this.contentContainer.find("section").empty(), this.contentContainer.find("p").empty())
    },
    ...
    createGradientOverlay: function(a, b, c, d, g) {
        if (SKY.Utils.hasCanvasSupport()) {
            var e = jQuery('<canvas class="sc-overlay" width="' + g + '" height="1"></canvas'),
...
function onResize() {
	...
	if( _winWIdth > 1120){
		...
		jQuery('.sky-carousel').carousel({
			...
			itemHeight: 275,
			distance: 39,
			selectedItemDistance: 85,
			selectedItemZoomFactor: 1,
			unselectedItemZoomFactor: 0.5,
			unselectedItemAlpha: 1,
			motionStartDistance: 275,
			topMargin: 0,
			loop: 0,
			gradientStartPoint: 0.35,
			selectByClick: true,
