...
$(".flex ul li img").click(function(){

	var capturaIndice = $(this).attr("value");

	$(".destacados figure.visor img").hide();
...
EFECTO LUPA
=============================================*/
$(".destacados figure.visor img").mouseover(function(event){
...
$(".destacados figure.visor img").mouseout(function(event){

	$(".lupa").fadeOut("fast");

})

$(".destacados figure.visor img").mousemove(function(event){
